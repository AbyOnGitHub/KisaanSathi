    ...
    <div className="card" style={{ backgroundColor: '#f9fcf9' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', fontSize: '0.88rem' }}>
        <div style={{ display: 'flex', gap: '0.65rem' }}>
          ...
          <div>
            <strong style={{ color: 'var(--text-main)' }}>Water & Moisture:</strong>
        ...
        <div style={{ display: 'flex', gap: '0.65rem' }}>
          ...
          <div>
            <strong style={{ color: 'var(--text-main)' }}>Balanced N-P-K:</strong>
            <p style={{ color: 'var(--text-muted)' }}>
        ...
        <div style={{ display: 'flex', gap: '0.65rem' }}>
          ...
          <div>
            <strong style={{ color: 'var(--text-main)' }}>Temperature Range:</strong>
            <p style={{ color: 'var(--text-muted)' }}>
