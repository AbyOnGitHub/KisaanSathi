...
export default function RoleSelect() {
  ...
  const handleSelectRole = (role) => {
    localStorage.setItem('kisaansathi_selected_role', role);
      ...
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">
            KisaanSathi <span className="text-green-700 font-semibold text-2xl sm:text-3xl">| किसान साथी</span>
          </h1>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-2.5 leading-relaxed">
                  Access AI-driven Crop Yield Prediction, localized farming insights, rainfall & soil condition analysis, and multilingual advisory.
                </p>
              </div>
              ...
              <div className="space-y-1.5 pt-2 border-t border-gray-100 text-xs text-gray-500">
                <div className="flex items-center gap-2">
                  ...
                  <span>ML-based Crop Yield Prediction</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle size={14} className="text-green-600" />
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle size={14} className="text-green-600" />
                  <span>Soil N-P-K & Weather Analysis</span>
                </div>
              </div>
            </div>
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-500 gap-3 border-t border-gray-200/80">
          <p>© 2025 KisaanSathi. Dedicated to empowering Indian Agriculture.</p>
          <button
            type="button"
