...
import { Star, CheckSquare, Square, RotateCcw, Filter, ChevronDown, ChevronUp } from 'lucide-react';
...
export const ProductFilters = ({
  ...
  const categories = [
    ...
    { id: 'seeds', label: '🌱 Seeds & Saplings' },
    { id: 'fertilizers', label: '🧪 Fertilizers & Nutrients' },
    { id: 'pesticides', label: '🛡️ Pesticides & Fungicides' },
    { id: 'tools', label: '🚜 Machinery & Tools' },
    { id: 'irrigation', label: '💧 Drip & Irrigation Pipes' },
  ];
      ...
      <div className="border-b border-gray-100 pb-4 mb-4">
        <label className="flex items-center gap-2 cursor-pointer select-none">
          ...
          <span className="font-bold text-gray-900 flex items-center gap-1">
            <span>💬 Bargain Available Only</span>
          </span>
        </label>
        <p className="text-[10px] text-gray-400 mt-1 pl-6">
          Show products open to direct price negotiation
        </p>
      </div>
            ...
            {discountOptions.map((d) => (
              ...
              >
                <input
                  ...
                  className="accent-agri-primary cursor-pointer"
                />
                <span className="font-medium">{d}% off or more</span>
              </label>
            ))}
          </div>
        )}
